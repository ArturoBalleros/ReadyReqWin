namespace ReadyReq.Util
{
    public struct Español
    {
        ...
        public const string Actores = "Actores";
        public const string ReqInfo = "Requisitos de Información";
        public const string ReqFun = "Requisitos Funcionales";
        public const string ReqNFun = "Requisitos no Funcionales";
        public const string Configuración = "Configuración";
        public const string Nue_Proy = "Nuevo Proyecto";
        public const string Importar_BD = "Importar a Base de Datos";
    ...
    public struct Ingles
    {
        ...
        public const string ReqInfo = "Information Requirements";
        public const string ReqFun = "Functional Requirements";
        public const string ReqNFun = "Non-functional requirements";
        public const string Configuration = "Configuration";
        public const string New_Proj = "New Project";
        public const string Import_DB = "Import to Database";
